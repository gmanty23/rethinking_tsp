...
OUT_CSV="results/experiment1_final_TSP50.csv"
LOG_FILE="results/eval_run_log_TSP50.txt"  # <--- New Log File

# Collect all epoch-99 models
MODELS=$(ls outputs/windy_tsp_50-50/004_exp1_eval_TSP50/*/*/epoch-99.pt)
