...
# Keeping Batch Size 512 to ensure 6 parallel runs fit in 16GB VRAM.
BATCH_SIZE=512
# 3 Workers per run * 6 runs = 18 cores. Leaves 6 cores for OS/Python overhead.
NUM_WORKERS=3   
...
PROBLEM="windy_tsp"
GRAPH_SIZE=20 
ENTROPY_VALUES=(0.01 0.2 1.0)
FEATURE_TYPES=("learned" "hybrid")

# --- DATA SETTINGS ---
VAL_DATA="data/windy_tsp/windy_tsp20_stats_val.pkl"
VAL_SIZE=5120
EPOCH_SIZE=1280000 
ROLLOUT_SIZE=10240
...
TEMP_RESULTS_DIR="results/windy_tsp20_stats_val"
...
# ==================================================
echo "=================================================="
echo "Launching 6 parallel experiments..."
echo "=================================================="
...
echo "----------------------------------------------------------------"
echo "All 6 processes running. PIDs: ${PIDS[*]}"
