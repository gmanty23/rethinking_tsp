...
echo "=================================================="
echo "Running LKH Solver (Forcing Regeneration)..."
echo "=================================================="

# Remove previous target if it exists to ensure fresh copy
rm -f "$LKH_TARGET"
...
# num_workers 4 is the sweet spot for your 24-core CPU
