...
# --- PATHS ---
LOG_DIR="logs_windy_tsp_mlp100_ablation"
OUTPUT_DIR="outputs/mlp100_ablation" # Standard base output directory for Rethinking TSP
mkdir -p $LOG_DIR
...
# Master Log File
LOG_FILE="${LOG_DIR}/tsp_mlp100_ablation_study.log"

# Initialize Log
echo "==================================================" > "$LOG_FILE"
echo "STARTING CONTINUOUS PARALLEL MLP100 ABLATION STUDY" >> "$LOG_FILE"
...
for GRAPH_SIZE in "${GRAPH_SIZES[@]}"; do
    ...
    for FEAT in "${FEATURES[@]}"; do            
        RUN_NAME="mlp100_tsp${GRAPH_SIZE}_${FEAT}_ent${ENTROPY}"
        ...
        echo " -> Launching: Size=${GRAPH_SIZE} | Feature=${FEAT}" | tee -a "$LOG_FILE"
