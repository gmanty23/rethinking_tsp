...
def process_data(csv_path):
    ...
    # Filter out LKH and Blank models completely 
...
# --- PLOTTING ---
def plot_dirichlet_energy(df, hue_order, palette):
    ...
    ax = sns.scatterplot(
        data=df,
        x='Avg_Dirichlet_Energy',  # <-- TARGETING THE NEW METRIC
        y='Gap_MoR',
        hue='Arch_Group',
        hue_order=hue_order,
        palette=palette,
...
if __name__ == "__main__":
    ...
    plot_dirichlet_energy(df, hue_order, palette)